...
import statsPlaceholder from '../../Placeholders/Pokemon/statsPlaceholder';

const PokemonStats = () => {
    const { pokemon, loading, statTotal } = useContext(PokemonContext);
    ...
    const displayStats = () => {
        ...
        return (
            <ReactPlaceholder ready={!loading} customPlaceholder={statsPlaceholder}>
                <Stats>
